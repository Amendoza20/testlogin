...
import com.amm.loginserver.security.JWTAuthentication;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable().authorizeRequests().antMatchers("*").permitAll().antMatchers("*").permitAll().anyRequest().authenticated();
